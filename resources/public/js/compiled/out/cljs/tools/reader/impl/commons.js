...
var G__27557 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27557;
continue;
} else {
return ch;
...
var vec__27558 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__27558,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27561){
...
return (function() { 
var G__27566__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__27566 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27567__i = 0, G__27567__a = new Array(arguments.length -  1);
while (G__27567__i < G__27567__a.length) {G__27567__a[G__27567__i] = arguments[G__27567__i + 1]; ++G__27567__i;}
  _ = new cljs.core.IndexedSeq(G__27567__a,0,null);
} 
return G__27566__delegate.call(this,rdr,_);};
G__27566.cljs$lang$maxFixedArity = 1;
G__27566.cljs$lang$applyTo = (function (arglist__27568){
var rdr = cljs.core.first(arglist__27568);
var _ = cljs.core.rest(arglist__27568);
return G__27566__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1531487544558
