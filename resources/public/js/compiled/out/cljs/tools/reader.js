...
var G__27596 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27596;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27597 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27597,ch);
...
if(("\\" === ch__$1)){
var ch_27598__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27598__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27598__$2);
} else {
}

var G__27599 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27599;
continue;
}
}
...
var vec__27607 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27607,(0),null);
var start_column = cljs.core.nth.call(null,vec__27607,(1),null);
...
var G__27610 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27610;
continue;
}
}
...
var _STAR_read_delim_STAR_27611 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27611;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27612 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27612,(0),null);
var start_column = cljs.core.nth.call(null,vec__27612,(1),null);
...
var vec__27615 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27615,(0),null);
var end_column = cljs.core.nth.call(null,vec__27615,(1),null);
...
var sb = (function (){var G__27630 = (new goog.string.StringBuffer());
G__27630.append(initch);
...
var G__27632 = (function (){var G__27631 = sb;
G__27631.append(ch);

return G__27631;
})();
var G__27633 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27632;
ch = G__27633;
continue;
}
...
switch (G__27636) {
case "\\":
var G__27640 = (function (){var G__27637 = sb;
G__27637.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27637;
})();
var G__27641 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27640;
ch = G__27641;
continue;
...
break;
default:
var G__27642 = (function (){var G__27638 = sb;
G__27638.append(ch);

return G__27638;
})();
var G__27643 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27642;
ch = G__27643;
continue;
...
var vec__27644 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27644,(0),null);
var end_column = cljs.core.nth.call(null,vec__27644,(1),null);
...
var vec__27647 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27647,(0),null);
var column = cljs.core.nth.call(null,vec__27647,(1),null);
...
var vec__27652 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27652,(0),null);
var column = cljs.core.nth.call(null,vec__27652,(1),null);
...
var vec__27657 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27657,(0),null);
var column = cljs.core.nth.call(null,vec__27657,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27662 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27662,(0),null);
var start_column = cljs.core.nth.call(null,vec__27662,(1),null);
...
var vec__27665 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27665,(0),null);
var end_column = cljs.core.nth.call(null,vec__27665,(1),null);
...
var G__27668 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27668,true,null,opts,pending_forms);
...
var G__27669 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27669)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27669)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27669)){
...
var _STAR_suppress_read_STAR_27670 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27670;
}});
...
var G__27671 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27671,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27671,rdr,first_line);
...
var G__27675 = matched;
var G__27676 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27675;
finished = G__27676;
continue;
} else {
...
var _STAR_suppress_read_STAR_27677 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27677;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27678 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27679 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27679,"(");
...
var G__27680 = (i + (1));
var G__27681 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27678;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27682 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27682);
...
var G__27683 = cljs.core.next.call(null,s__$1);
var G__27684 = ret;
s__$1 = G__27683;
r = G__27684;
continue;
...
var G__27685 = cljs.core.next.call(null,s);
var G__27686 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27685;
key_vals = G__27686;
continue;
} else {
...
var gensym_env27690 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27690;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27691 = token;
var G__27691__$1 = (((G__27691 == null))?null:cljs.core.subs.call(null,G__27691,(1)));
var G__27691__$2 = (((G__27691__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27691__$1));
var G__27691__$3 = (((G__27691__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27691__$2));
var G__27691__$4 = (((G__27691__$3 == null))?null:cljs.core.symbol.call(null,G__27691__$3));
if((G__27691__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27691__$4);
}
})():(function (){var G__27692 = token;
var G__27692__$1 = (((G__27692 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27692));
if((G__27692__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27692__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27703,reader){
...
var eof = cljs.core.get.call(null,map__27704__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27710){
var G__27711 = cljs.core.first.call(null,seq27710);
var seq27710__$1 = cljs.core.next.call(null,seq27710);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27711,seq27710__$1);
});


//# sourceMappingURL=reader.js.map?rel=1531487544990
