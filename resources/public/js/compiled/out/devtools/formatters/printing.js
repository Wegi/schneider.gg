...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26714){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26715,G__26716,seq26714__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26720_SHARP_){
return !((cljs.core.meta.call(null,p1__26720_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__26721__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26725){var _e__25705__auto__ = e26725;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e26727){var _e__25705__auto__ = e26727;
return false;
}}
})())){
...
var _STAR_current_state_STAR_26729 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__26730 = opts;
var map__26730__$1 = ((((!((map__26730 == null)))?(((((map__26730.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26730.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26730):map__26730);
var markup_db = cljs.core.get.call(null,map__26730__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_26729;
}});
...
;
var temp__5455__auto___26734 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___26734)){
var managed_print_level_26735 = temp__5455__auto___26734;
var _STAR_print_level_STAR_26733_26736 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_26735;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_26733_26736,managed_print_level_26735,temp__5455__auto___26734,writer,opts,job_fn){
return (function (p1__26732_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__26732_SHARP_,null);
});})(_STAR_print_level_STAR_26733_26736,managed_print_level_26735,temp__5455__auto___26734,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_26733_26736;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1531487542734
