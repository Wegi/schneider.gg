...
var o26586 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26586["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26587 = temp__5455__auto____$1;
return (o26587["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25698__auto__ = f;
return (o__25698__auto__["toString"]).call(o__25698__auto__);
} else {
return "";
}
}catch (e26588){var _ = e26588;
return "";
}});
...
try{var o__25698__auto___26590 = t;
(o__25698__auto___26590["cljs$lang$ctorPrWriter"]).call(o__25698__auto___26590,t,writer);
}catch (e26589){var __26591 = e26589;
}
...
var char_code = (function (){var o__25698__auto__ = (new String(char$));
return (o__25698__auto__["charCodeAt"]).call(o__25698__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25698__auto__ = String;
return (o__25698__auto__["fromCharCode"]).call(o__25698__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26592 = num_code;
switch (G__26592) {
case (1):
return (185);
...
var o__25698__auto__ = String;
return (o__25698__auto__["fromCharCode"]).call(o__25698__auto__,superscript_code);
});
/**
...
}catch (e26594){var _e__25705__auto__ = e26594;
return false;
}})())){
...
var vec__26595 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26595,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o26598 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26598["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26599 = temp__5455__auto____$1;
return (o26599["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___26606 = arguments.length;
var i__4532__auto___26607 = (0);
while(true){
if((i__4532__auto___26607 < len__4531__auto___26606)){
args__4534__auto__.push((arguments[i__4532__auto___26607]));

var G__26608 = (i__4532__auto___26607 + (1));
i__4532__auto___26607 = G__26608;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26602){
var vec__26603 = p__26602;
var ns_detector = cljs.core.nth.call(null,vec__26603,(0),null);
...
var G__26609 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26610 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26609;
remaining_tokens = G__26610;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26600){
var G__26601 = cljs.core.first.call(null,seq26600);
var seq26600__$1 = cljs.core.next.call(null,seq26600);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26601,seq26600__$1);
});
...
var vec__26614 = cljs.core.split_with.call(null,(function (p1__26613_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26613_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26614,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26614,(1),null);
...
var vec__26617 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26617,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26617,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26620 = cljs.core.rest.call(null,remaining_tokens);
var G__26621 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26620;
name_tokens = G__26621;
continue;
} else {
...
var vec__26624 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26624,(0),null);
var arity = cljs.core.nth.call(null,vec__26624,(1),null);
var vec__26627 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26627,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26627,(1),null);
var vec__26630 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26630,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26630,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26630,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26630,(3),null);
...
var vec__26636 = result;
var munged_ns = cljs.core.nth.call(null,vec__26636,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26636,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26636,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26636,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26636,(4),null);
var arity = cljs.core.nth.call(null,vec__26636,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__26640 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__26640,(0),null);
var args = cljs.core.nth.call(null,vec__26640,(1),null);
var vec__26643 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26643,(0),null);
var name = cljs.core.nth.call(null,vec__26643,(1),null);
...
var G__26646 = (arity + (1));
var G__26647 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26648){
var vec__26649 = p__26648;
var arity = cljs.core.nth.call(null,vec__26649,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26649,(1),null);
...
return cljs.core.get.call(null,arities,p1__26652_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26653_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___26660 = arguments.length;
var i__4532__auto___26661 = (0);
while(true){
if((i__4532__auto___26661 < len__4531__auto___26660)){
args__4534__auto__.push((arguments[i__4532__auto___26661]));

var G__26662 = (i__4532__auto___26661 + (1));
i__4532__auto___26661 = G__26662;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26656){
var vec__26657 = p__26656;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26657,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26654){
var G__26655 = cljs.core.first.call(null,seq26654);
var seq26654__$1 = cljs.core.next.call(null,seq26654);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26655,seq26654__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26665__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26665__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26665__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26665__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26666 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26666,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26666,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26666,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26666,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26666,(4),null);
var arity = cljs.core.nth.call(null,vec__26666,(5),null);
...
var o__25698__auto__ = f;
return (o__25698__auto__["getBasis"]).call(o__25698__auto__);
});
/**
...
}catch (e26670){var _e__25705__auto__ = e26670;
...
var G__26671 = (obj[cljs.core.first.call(null,path)]);
var G__26672 = cljs.core.rest.call(null,path);
obj = G__26671;
path = G__26672;
continue;
} else {
...
return (function (accum,p__26673){
var vec__26674 = p__26673;
var bit = cljs.core.nth.call(null,vec__26674,(0),null);
var protocol = cljs.core.nth.call(null,vec__26674,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26677){
var vec__26678 = p__26677;
var ns = cljs.core.nth.call(null,vec__26678,(0),null);
var name = cljs.core.nth.call(null,vec__26678,(1),null);
var selector = cljs.core.nth.call(null,vec__26678,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26683,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26683,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26681_SHARP_){
return (obj[cljs.core.first.call(null,p1__26681_SHARP_)]);
});})(name,sorted_matches,vec__26683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1531487542498
