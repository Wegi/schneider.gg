...
return (new CustomEvent(event_name,(function (){var obj30098 = {"detail":data};
return obj30098;
})()));
} else {
...
var f = (function (){var pred__30105 = cljs.core._EQ_;
var expr__30106 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30105.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30106))){
return ((function (pred__30105,expr__30106){
return (function (p1__30099_SHARP_){
return console.warn(p1__30099_SHARP_);
});
;})(pred__30105,expr__30106))
} else {
if(cljs.core.truth_(pred__30105.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30106))){
return ((function (pred__30105,expr__30106){
return (function (p1__30100_SHARP_){
return console.debug(p1__30100_SHARP_);
});
;})(pred__30105,expr__30106))
} else {
if(cljs.core.truth_(pred__30105.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30106))){
return ((function (pred__30105,expr__30106){
return (function (p1__30101_SHARP_){
return console.error(p1__30101_SHARP_);
});
;})(pred__30105,expr__30106))
} else {
return ((function (pred__30105,expr__30106){
return (function (p1__30102_SHARP_){
return console.log(p1__30102_SHARP_);
});
;})(pred__30105,expr__30106))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30109){
...
var eval_fn = cljs.core.get.call(null,map__30110__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30112_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30114,(0),null);
var v = cljs.core.nth.call(null,vec__30114,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1531487547622
